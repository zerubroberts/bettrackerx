...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'custom-focus': '0 0 0 3px rgba(66, 153, 225, 0.5)',
      },
      borderRadius: {
      ...
      animation: {
        ...
        'bounce-limited': 'bounceLimited 1s ease-in-out',
  ...
  safelist: [
    ...
    ...["primary", "secondary", "success", "danger", "warning", "neutral"].flatMap(
      (prefix) => [
        ...Array.from({ length: 10 }, (_, i) => 
          [
            `bg-${prefix}-${(i + 1) * 100}`,
            `text-${prefix}-${(i + 1) * 100}`,
            `border-${prefix}-${(i + 1) * 100}`,
            `ring-${prefix}-${(i + 1) * 100}`,
            `stroke-${prefix}-${(i + 1) * 100}`,
            `fill-${prefix}-${(i + 1) * 100}`
          ]
        ).flat(),
        `bg-${prefix}-50`,
